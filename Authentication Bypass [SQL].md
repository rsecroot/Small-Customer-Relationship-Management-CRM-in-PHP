...
- Affected URL: http://127.0.0.1/crm/admin/index.php
...
The login functionality in [specific file, e.g., /crm/admin/index.php] does not  properly sanitize user input before using it in SQL queries. This  allows an attacker to inject malicious SQL code through the username parameter.
...
1. Navigate to the login page: http://127.0.0.1/crm/admin/index.php
